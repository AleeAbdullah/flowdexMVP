...
export const Env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_ETH_TREASURY_ADDRESS: z.string().optional(),
    NEXT_PUBLIC_SOL_TREASURY_ADDRESS: z.string().optional(),
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_ETH_TREASURY_ADDRESS: process.env.NEXT_PUBLIC_ETH_TREASURY_ADDRESS,
    NEXT_PUBLIC_SOL_TREASURY_ADDRESS: process.env.NEXT_PUBLIC_SOL_TREASURY_ADDRESS,
