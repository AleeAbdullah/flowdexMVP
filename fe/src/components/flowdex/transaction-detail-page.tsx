...
export function TransactionDetailPage(props: {
  ...
  return (
    <div className="space-y-8">
        ...
        <GlassPanel className="p-6">
          ...
          {transaction.refund ? (
            ...
            <div className="space-y-3">
              <div className="text-lg font-bold text-[var(--text)]">No refund on record</div>
      ...
      <GlassPanel className="p-6">
        <div className="text-[10px] font-bold tracking-[0.28em] text-[color-mix(in_srgb,var(--text)_52%,transparent)] uppercase">Lifecycle Timeline</div>
...
function LifecycleStep(props: {
  ...
  return (
    <div className={`rounded-[1.2rem] border p-4 ${props.active ? 'border-[var(--cyan)] bg-[var(--accent-bg)]' : 'border-[var(--card-border)] bg-[var(--card-bg)]'}`}>
