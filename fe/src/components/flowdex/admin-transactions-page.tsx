  ...
  return (
    <div className="space-y-8">
      ...
      <GlassPanel className="overflow-hidden">
        ...
        <div>
          {query.isLoading ? (
            <div className="px-6 py-5 text-sm text-slate-300">Loading admin transactions...</div>
          ) : null}
          {query.isError ? (
...
function InputField(props: {
  ...
  return (
    <label className="block space-y-2">
      <span className="text-[10px] font-semibold tracking-[0.28em] text-slate-500 uppercase">{props.label}</span>
      <Input
        type={props.type}
        value={props.value}
